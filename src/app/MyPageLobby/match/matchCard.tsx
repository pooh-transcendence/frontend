  ...
  { // left is winner
      return (
        <div className="Property1Win w-[900px] h-[65px] relative">
          ...
          <div className="BallSpeedModerate left-[747px] top-[14px] absolute text-right text-neutral-600 text-base font-normal w-[20rem]">{getGameSettingString(game)}</div>

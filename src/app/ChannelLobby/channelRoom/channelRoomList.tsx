  ...
  return (
    <>
      ...
      <img
        ...
        src="/vector1.svg"
      />
      <div className="absolute h-[87.46%] w-[93.56%] top-[9.24%] right-[2.82%] bottom-[3.3%] left-[3.62%] overflow-y-auto flex flex-col items-start justify-start gap-[0.81rem] text-right text-[0.81rem] text-[#555555]">
        ...
        </div>
        {
          channels.filter((elem) => elem.channelType === "PUBLIC").map((elem) => {
            return <ChannelListComponent channel={elem} />
          })
        }
